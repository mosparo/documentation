  ...
  docs: [
    {
      ...
      items: [
        ...
        },
        {
          type: 'link',
          label: 'HowTo Videos',
          href: 'https://www.youtube.com/playlist?list=PLU08cA46o_OKsdKqUTfr0aFMn3Aef9GCd',
        }
      ],
    },
    'quickstart',
      ...
      items: [
        ...
        },
        {
          ...
          link: {
            type: 'generated-index',
            title: 'Configure',
            description: 'Learn how to configure your web server and additional services.',
            slug: '/category/installation/configure',
            keywords: ['configure'],
          },
          items: [
            {
              type: 'autogenerated',
              dirName: '3_installation/3_configure'
            }
          ]
        },
        'installation/update'
